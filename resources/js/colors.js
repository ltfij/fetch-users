...
export const getButtonColor = (color, isOutlined, hasHover) => {
  const colors = {
    bg: {
      ...
      primary: 'bg-emerald-500 dark:bg-emerald-400 text-white'
    },
    bgHover: {
      ...
      primary: 'hover:bg-emerald-700 hover:border-emerald-700 hover:dark:bg-emerald-600 hover:dark:border-emerald-600'
    },
    borders: {
      ...
      // primary: 'border-emerald-600 dark:border-emerald-500'
    },
    text: {
      white: 'text-black dark:text-slate-100',
    ...
    outlineHover: {
      ...
      primary: 'hover:bg-emerald-600 hover:text-white hover:dark:text-white hover:dark:border-emerald-600'
    }
  }
